...
- Each entity carries its own pause flag in `entity.data`, allowing different entities in the same PathSpace to behave differently (e.g., threaded vs non-threaded lanes).
