...
- `@/components/game/engine/domain/read`
- `@/components/game/engine/domain/adt`

Advanced imports (intentional, not default):

- `@/components/game/engine/runtime/behavior`
- `@/components/game/engine/domain/question`
- `@/components/game/engine/domain/transformers`
- `@/components/game/engine/application`

Forbidden legacy imports:

- `@/components/game/engine/domain/entity/entity-fns`
- `@/components/game/engine/domain/space/space-fns`
- `@/components/game/engine/domain/space/validation`
- `@/components/game/engine/runtime/selectors/*`
...
- Import: `@/components/game/engine/domain/adt`
...
### Canonical reads from `@/components/game/engine/domain/read`
...
- Import: `@/components/game/engine/domain/entity/entity-data`
...
- Import: `@/components/game/engine/domain/space`
...
### Declarative condition helpers from `@/components/game/engine/domain/question`
...
## 7) Advanced Behavior Module (`@/components/game/engine/runtime/behavior`)
