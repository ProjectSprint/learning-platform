# Building Questions — Step-by-Step Guide

This guide walks through creating a new interactive question from scratch.
It covers file structure, constants, definition, behaviors, page component,
and all wiring needed for a fully functional question.
